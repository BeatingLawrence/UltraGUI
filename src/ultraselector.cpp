...
//=========================================================
uint32_t UltraSelector::_selectorToAnimation() { return (m_selector * 100); }
//=========================================================
...
//=========================================================
UltraSelector::~UltraSelector() { m_timer.stop(); }
//=========================================================
void UltraSelector::addEntry(const UltraEntry& entry)
{
