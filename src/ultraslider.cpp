...
//=========================================================
float UltraSlider::_sliderToPixel(float slider)
{
...
//=========================================================
float UltraSlider::_pixelToSlider(float pixels)
{
    pixels -= _one_margin();
...
//=========================================================
float UltraSlider::_cap(float val)
{
...
//=========================================================
float UltraSlider::_all_margins() { return (float)height(); }
//=========================================================
float UltraSlider::_one_margin() { return (float)height() / 2.0f; }
//=========================================================
void UltraSlider::_incSlider(float x)
{
    if (m_slider + x > m_max)
        m_slider = m_max;
    else
...
//=========================================================
void UltraSlider::_decSlider(float x)
{
    if (m_slider - x < m_min)
        m_slider = m_min;
    else
...
//=========================================================
void UltraSlider::set(float value)
{
    if (value < m_min)
        m_slider = m_min;
    else if (value > m_max)
