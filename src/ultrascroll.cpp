...
//=========================================================
UltraScroll::UltraScroll(QWidget* parent)
    : QWidget(parent),
      m_hovering(UltraScroll::HE_NoHovering),
      m_pressed(UltraScroll::PE_NoPressing),
      m_selector(0),
...
//=========================================================
UltraScroll::~UltraScroll() { m_timer.stop(); }
//=========================================================
void UltraScroll::addEntry(const UltraEntry& entry)
{
    m_entries.push_back(entry);
    update();
}
//=========================================================
bool UltraScroll::setEntries(const QVector<UltraEntry>& entries)
{
