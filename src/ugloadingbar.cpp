...
const int UGLoadingBar::RefreshPeriodMs(20);

//=========================================================
UGLoadingBar::UGLoadingBar(QWidget* parent)
    : QWidget(parent),
      m_timer(this),
      m_setPoint(0),
      m_progress(0),
      ...
      m_drawBackGround(true)
{
    ...
    m_timer.setInterval(UGLoadingBar::RefreshPeriodMs);
}
//=========================================================
UGLoadingBar::~UGLoadingBar() { m_timer.stop(); }
//=========================================================
void UGLoadingBar::setProgressBar(int status)
{
...
//=========================================================
void UGLoadingBar::setProgressBarToZero()
{
    m_progress = 0;
    m_setPoint = 0;
    m_pixels   = 0;
...
//=========================================================
void UGLoadingBar::_onTimerTick()
{
...
//=========================================================
void UGLoadingBar::paintEvent(QPaintEvent* event)
{
    (void)event;
