#ifndef HCI_ULTRASELECTOR_H
#define HCI_ULTRASELECTOR_H
...
namespace hci
{
    class ULTRAGUI_EXPORT UltraSelector : public QWidget
    {
        ...
        private:
            ...
            QVector<UltraTypes::UltraEntry> m_entries;
        ...
        public:
            ...
            void addEntry(const UltraTypes::UltraEntry& entry);
            ...
            bool setEntries(const QVector<UltraTypes::UltraEntry>& entries);
