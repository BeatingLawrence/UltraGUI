...
//============================================================
UltraLoadingSquares::UltraLoadingSquares(QWidget* parent) : QWidget(parent),
    m_loading(false),
    m_animation(0),
    m_timer(),
...
void UltraLoadingSquares::paintEvent(QPaintEvent* event)
{
    ...
    painter.fillRect(QRect(QPoint(width() - xPos - m_tinyRectSize.width(), height() - yPos - m_tinyRectSize.height()), m_tinyRectSize),
